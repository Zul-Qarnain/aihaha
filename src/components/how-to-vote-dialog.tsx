    ...
    <AlertDialog open={isOpen} onOpenChange={onClose}>
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="text-base text-center py-4 space-y-4">
            <p>Get ready to cast your vote. Here are the rules:</p>
            ...
            <p>You have 30 seconds. Make it count!</p>
          </AlertDialogDescription>
        </AlertDialogHeader>
